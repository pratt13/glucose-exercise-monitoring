...
def install_unpacked_wheel(
    ...
    if pip_script:
        ...
        scripts_to_generate.append("pip%s = %s" % (get_major_minor_version(), pip_script))
...
def install_wheel(
    ...
    # type: (...) -> None
    with TempDirectory(path=_temp_dir_for_testing, kind="unpacked-wheel") as unpacked_dir, ZipFile(
        wheel_path, allowZip64=True
    ) as z:
