        ...
        with indent_log():
            ...
            if os.path.exists(os.path.join(req.source_dir, "setup.py")):
                raise PreviousBuildDirError(
                    ...
                    "can delete this. Please delete it and try again.".format(req, req.source_dir)
                )
            ...
            if download_dir:
                ...
                elif local_path and not os.path.exists(os.path.join(download_dir, link.filename)):
