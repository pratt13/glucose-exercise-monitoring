...
class InstallCommand(RequirementCommand):
    ...
    def __init__(self, *args, **kw):
        ...
        cmd_opts.add_option(
            "--no-user", dest="use_system_location", action="store_true", help=SUPPRESS_HELP
        )
        cmd_opts.add_option(
            "--root",
            dest="root_path",
        ...
        cmd_opts.add_option(
            ...
            action="store_true",
            help="Install using the system scheme (overrides --user on " "Debian systems)",
        )
    ...
    def run(self, options, args):
        ...
        with get_requirement_tracker() as req_tracker, TempDirectory(
            ...
            try:
                ...
                warn_deprecated_install_options(requirement_set, options.install_options)
...
def warn_deprecated_install_options(requirement_set, options):
    ...
    deprecated(
        ...
        replacement=("using pip-level options like --user, --prefix, --root, and " "--target"),
        gone_in="20.2",
        issue=7309,
    )
