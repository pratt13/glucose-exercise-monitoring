    ...
    with indent_log():
        for requirement in to_install:
            ...
            try:
                ...
                should_rollback = requirement.should_reinstall and not requirement.install_succeeded
                # if install did not succeed, rollback previous uninstall
                if should_rollback:
                    uninstalled_pathset.rollback()
                raise
            else:
                should_commit = requirement.should_reinstall and requirement.install_succeeded
                if should_commit:
