...
class WheelMetadata(DictMetadata):
    ...
    def get_metadata(self, name):
        ...
        try:
            ...
            raise UnsupportedWheel("Error decoding metadata for {}: {}".format(self._wheel_name, e))
...
def pkg_resources_distribution_for_wheel(wheel_zip, name, location):
    ...
    metadata_files = [p for p in wheel_zip.namelist() if p.startswith("{}/".format(info_dir))]
    ...
    for path in metadata_files:
        ...
        try:
            metadata_text[metadata_name] = read_wheel_metadata_file(wheel_zip, full_path)
