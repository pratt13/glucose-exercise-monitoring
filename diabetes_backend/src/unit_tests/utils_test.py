...
class TestUtils(unittest.TestCase):
    ...
    def test_glucose_raw_data(self):
        data = [
            Glucose(id=2, timestamp=dt(2024, 1, 2, 12, 5, 0), glucose=5),
            Glucose(id=1, timestamp=dt(2024, 1, 1, 12, 5, 0), glucose=4),
            Glucose(id=3, timestamp=dt(2024, 1, 3, 12, 5, 0), glucose=6),
        ]
        self.assertCountEqual(
            glucose_raw_data(data),
            [
                {
                    "id": 1,
                    "glucose": 4,
                    "timestamp": dt(2024, 1, 1, 12, 5),
                },
                {
                    "id": 2,
                    "glucose": 5,
                    "timestamp": dt(2024, 1, 2, 12, 5),
                },
                {
                    "id": 3,
                    "glucose": 6,
                    "timestamp": dt(2024, 1, 3, 12, 5),
                },
            ],
        )

    def test_strava_raw_data(self):
        default_kwargs = {
            "start_latitude": 3,
            "end_latitude": 3.1,
            "start_longitude": 3.2,
            ...
            "moving_time": 10.5,
            "elapsed_time": 30.6,
            "end_time": dt(2024, 1, 2, 12, 5, 0),
        }
        data = [
            Strava(
                id=2,
                start_time=dt(2024, 1, 2, 12, 5, 0),
                distance=5,
                activity_type="WALK",
                **default_kwargs,
            ),
        ...
        self.assertCountEqual(
            strava_raw_data(data),
            [
                {
                    **default_kwargs,
                    "id": 1,
                    "distance": 4,
                    "start_time": dt(2024, 1, 1, 12, 5),
                    "activity_type": "CYCLE",
                },
                {
                    **default_kwargs,
                ...
                },
                {
                    **default_kwargs,
                    "id": 3,
                    "distance": 6,
                    "start_time": dt(2024, 1, 3, 12, 5),
                    "activity_type": "RUN",
                },
            ],
        )

    def test_strava_glucose_raw_data(self):
        data = [
            GlucoseExercise(
                id=2,
                timestamp=dt(2024, 1, 2, 12, 5, 0),
                ...
                glucose_id="2",
                strava_id=2,
                strava_rec=Strava(id=2),
                glucose_rec=Glucose(
                    id=2, timestamp=dt(2024, 1, 2, 12, 5, 0), glucose=5
                ),
                distance=5,
            ),
            GlucoseExercise(
                ...
                glucose_id="1",
                glucose_rec=Glucose(
                    id=1, timestamp=dt(2024, 1, 1, 12, 5, 0), glucose=4
                ),
                strava_id=1,
                strava_rec=Strava(id=1),
                distance=5,
            ),
            GlucoseExercise(
                timestamp=dt(2024, 1, 3, 12, 5, 0),
                ...
                glucose_id="3",
                glucose_rec=Glucose(
                    id=3, timestamp=dt(2024, 1, 3, 12, 5, 0), glucose=6
                ),
                strava_id=3,
                strava_rec=Strava(id=3),
                distance=5,
            ),
        ]
        self.assertCountEqual(
            strava_glucose_raw_data(data),
            [
                {
                    "id": None,
                    "strava_id": 1,
